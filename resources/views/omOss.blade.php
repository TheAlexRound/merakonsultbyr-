                    ...
                    <div class="flex flex-col gap-4 pt-12 pb-12 mb-20 ">
                        ...
                        <div class="flex flex-col w-full gap-6 md:flex-row">
                            <div class="w-full p-8 bg-white shadow-sm rounded-4xl">
                                ...
                                <p class="text-gray-800 font-mont" aria-label="Mera Konsultbyrå">Vi gillar när det är enkelt, smidigt och funkar som det ska – gärna med hjälp av digitala verktyg som sparar både tid och energi. Samtidigt tror vi på det personliga mötet och finns alltid nära för våra kunder.
                                    <br><br>Hos oss får du en personlig kontakt som förstår både siffror och företagande.
                                    </p>
                            </div>
                        ...
                        <div class="flex flex-col gap-12">
                                ...
                                <div class="flex flex-col gap-1 px-6 pt-0 pb-12 md:pt-12">
                                    ...
                                    <div class="flex flex-col gap-4 pt-4 mt-auto -mb-2 sm:gap-10 md:flex-row">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <p class="text-gray-800 text- font-mont" aria-label="Mera Konsultbyrå">ak@merakonsult.se</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col w-full gap-12 bg-white shadow-sm md:flex-row rounded-4xl">
                                ...
                                <div class="flex flex-col gap-1 px-6 pt-0 pb-12 md:pt-12">
                                    ...
                                    <div class="pt-4">
                                        <p class="text-gray-800 text- font-mont" aria-label="Mera Konsultbyrå">Jag har alltid sagt att jag inte kommer fastna i samma yrkesroll hela livet, och det får jag verkligen utlopp för som redovisningskonsult. Ingen dag är den andra lik!</p>
                                        <p class="mt-2 text-gray-800 text- font-mont" aria-label="Mera Konsultbyrå">Med så många roliga företag vi arbetar med får jag ständigt bära olika hattar och agera problemlösare i en mängd olika branscher. Jag lär mig ständigt nya saker och till skillnad från vad många kan tro finns det inga tråkiga dagar som redovisningskonsult. </p>
                                    </div>
                                    <div class="flex flex-col gap-4 pt-4 mt-auto -mb-2 sm:gap-10 md:flex-row">
                                        <div class="flex items-center gap-2">
                                            <i class="fa-solid fa-phone text-[#b25659]"></i>
                            ...
                            <div class="flex flex-col w-full gap-12 bg-white shadow-sm md:flex-row rounded-4xl">
                                ...
                                <div class="flex flex-col gap-1 px-6 pt-0 pb-12 md:pt-12">
                                    ...
                                    <div class="pt-4">
                                        <p class="text-gray-800 text- font-mont" aria-label="Mera Konsultbyrå">Som en satsande längdskidåkare vet jag att hårt arbete kan löna sig. Därför älskar jag att arbeta med företagare, det finns ingen som sliter för sin dröm som en entreprenör. Oavsett målet vill jag stötta mina kunder på deras resa, lite som en funktionär i skidspåret kan man säga! Bara att jag langar ekonomiska rapporter istället för sportdryck.. </p>
                                        <p class="mt-2 text-gray-800 text- font-mont" aria-label="Mera Konsultbyrå"> Med min dubbelexamen inom både ekonomi och IT brinner jag även lite extra för digitalisering och hjälper gärna till att effektivisera processer. Det finns alltid smarta lösningar att hitta, bara man vågar be om hjälp!</p>
                                    </div>
                                    <div class="flex flex-col gap-4 pt-4 mt-auto -mb-2 sm:gap-10 md:flex-row">
                                        <div class="flex items-center gap-2">
                                            <i class="fa-solid fa-phone text-[#b25659]"></i>
