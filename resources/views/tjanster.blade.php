                ...
                <div class="max-w-[1500px] mx-auto w-full space-y-32 bg-gray-100">
                    ...
                    <div class="flex flex-col gap-12 pt-24 mb-24 ">
                        ...
                        <div class="flex flex-col w-full border border-gray-200 shadow-sm md:flex-row-reverse rounded-4xl">
                            <div style="background-image: url('/img/point.jpg')" class="w-full bg-center bg-cover rounded-b-none md:rounded-r-4xl rounded-4xl rounded-t-4xl md:rounded-l-none">
                                <div class="w-full h-full bg-radial-[at_150%_0%] from-transparent from-25% to-black to-90% opacity-95 rounded-4xl rounded-b-none rounded-t-4xl md:rounded-l-none md:rounded-r-4xl flex justify-center items-center p-8">
                                    <div class="w-full flex flex-col gap-4 border-4 border-[#b25659] py-12 md:py-24 border-x-0">
                                        ...
                                        <p class="text-lg tracking-tighter text-white max-w-2/3 md:text-xl font-mont" aria-label="Mera Konsultbyrå">Oavsett vad du står inför finns vi här – som ett engagerat stöd med fullt fokus på att du ska lyckas.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!--CARD-->
                        <div class="flex flex-col w-full border border-gray-200 shadow-sm md:flex-row rounded-4xl">
                            <div style="background-image: url('/img/type.jpg')" class="w-full bg-center bg-cover rounded-b-none md:rounded-l-4xl rounded-4xl rounded-t-4xl md:rounded-r-none">
                                <div class="w-full h-full bg-radial-[at_150%_0%] from-transparent from-25% to-black to-90% opacity-95 rounded-4xl rounded-b-none rounded-t-4xl md:rounded-r-none md:rounded-l-4xl flex justify-center items-center p-8">
                                    <div class="w-full flex flex-col gap-4 border-4 border-[#b25659] py-12 md:py-24 border-x-0">
                                        <h3 class="text-3xl tracking-tighter text-white lg:text-5xl md:text-4xl font-league" aria-label="Redovisning">Skatt</h3>
                                        <p class="text-lg tracking-tighter text-white max-w-2/3 md:text-xl font-mont" aria-label="Mera Konsultbyrå"> Ingen gillar överraskningar från Skatteverket. Med oss vid din sida slipper du dem.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-8 py-12 bg-white rounded-t-none md:rounded-l-none md:rounded-r-4xl rounded-4xl">
                                <h4 class="mb-8 text-center md:text-left tracking-tighter text-[#b25659] lg:text-4xl text-3xl font-league" aria-label="Våra tjänster">Skatt - lagom är bäst.</h4>
                                <p class="text-gray-800 text- font-mont" aria-label="Mera Konsultbyrå">Vi förstår att skatt sällan står högst upp på listan över saker man längtar efter att ta tag i. Men för oss är det något vi brinner för – inte för att det är kul med paragrafer, utan för att vi vet hur mycket det kan påverka din vardag som företagare eller privatperson.
                                    <br><br>Vårt mål är att göra skatt begripligt, hanterbart och framför allt rätt. Vi hjälper dig att undvika fallgropar, planera klokt och hålla dig på rätt sida reglerna – utan att betala mer än du behöver. Oavsett om det handlar om att deklarera som privatperson, hantera skattefrågor i din enskilda firma eller se över utdelning i ditt aktiebolag, finns vi här med trygg vägledning och praktisk hjälp.
                                    <br><br>Med oss slipper du överraskningar och får istället ett lugn i att allt är i sin ordning. Vi finns här året om – inte bara när det är deklarationsdags.
                                    </p>
                            </div>
                        </div>
                    </div>
