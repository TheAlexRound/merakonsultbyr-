...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex flex-col items-center bg-[#f7e6e7]">
        <!-- ========== HEADER ========== -->
            ...
            <nav class="mt-4 relative md:max-w-2xl w-full bg-white border border-gray-200 shadow-xl rounded-4xl mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto">
                ...
                <div id="navbar-menu" class="hidden overflow-hidden transition-all duration-300 ease-in-out hs-collapse max-h-0 md:max-h-none md:block" aria-labelledby="navbar-toggle">
                    <div class="flex flex-col gap-2 py-2 mt-3 md:flex-row md:items-center md:justify-end md:gap-3 md:mt-0 md:py-0 md:ps-7">
                        <a class="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-[#b25659] font-medium font-mont text-[#b25659] focus:outline-hidden" href="#" aria-current="page">Hem</a>
                        <a class="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-transparent font-mont text-gray-500 hover:text-gray-800 focus:outline-hidden" href="#">Tjänster</a>
                        <a class="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-transparent font-mont text-gray-500 hover:text-gray-800 focus:outline-hidden" href="#">Om Oss</a>
                    </div>
                </div>
            </nav>
        </header>
            ...
            <div class="flex flex-col w-full min-h-screen p-2 pt-4 md:p-10 bg-gray-50 gap-y-16">
                ...
                <div class="max-w-[1500px] mx-auto w-full space-y-32 bg-gray-50">
                    ...
                    <div class="flex flex-col gap-4 mb-20">
                        ...
                        <div class="relative bg-linear-to-bl from-[#b25659] via-transparent rounded-4xl border border-gray-200 shadow-sm">
                                            ...
                                            <div class="grid grid-cols-1 gap-4">
                                                ...
                                                <div>
                                                    <div class="w-full">
                                                        ...
                                                        <input type="email" name="email" id="email" class="py-2.5 font-mont sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-[#b25659] focus:ring-[#b25659] disabled:opacity-50 disabled:pointer-events-none" placeholder="Svensson">
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="mt-8">
                                                <button type="submit" class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white bg-[#b25659] border border-transparent rounded-lg gap-x-2 hover:cursor-pointer focus:outline-hidden hover:scale-102 transition-all duration-300 disabled:opacity-50 font-mont disabled:pointer-events-none">Skicka</button>
                                            </div>
